...
export default function Form({ setToDoList, toDoList }) {
  // Recibe las props desde el componente padre
  ...
  function handleSubmit(e) {
    ...
    if (toDo.name === "") {
      alert("Cant input an empty task");
      return;
    }

    if (toDoList.some((todo) => todo.name === toDo.name)) {
      alert("Cant duplicate tasks");
      return;
    }
        ...
        <input
          ...
          onChange={
            (e) =>
              ...
              }) /* camputarmos el valor del input en la propiedad name del objeto */
          }
          value={toDo.name}
          type="text"
